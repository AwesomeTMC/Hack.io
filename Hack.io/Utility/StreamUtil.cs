...
{
    /// <summary>
    /// Shortcut to EncodingUtil.ShiftJIS
    /// </summary>
    public static Encoding ShiftJIS => EncodingUtil.ShiftJIS;

    //====================================================================================================

    public static UtilityStream Wrap(this Stream stream, bool forceWrap = false)
    {
        if (!forceWrap && stream is UtilityStream myStream)
        {
            return myStream;
        }

        return new UtilityStream(stream);
    }
    ...
    [Obsolete("Use UtilityStream instead.")] 
    ...
    public static void ApplyEndian<T>(Span<T> data, StreamEndian Endian, bool Invert = false)
    {
        bool e = BitConverter.IsLittleEndian;
        if (Invert)
            e = !e;
